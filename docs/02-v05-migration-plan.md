...
- v0.5 실검증 전까지 destructive 작업은 자동화하지 않는다.
- v0.4 manifest 적용 실패는 정상적인 migration evidence로 기록한다.
...
- v0.4 manifest를 v0.5 CRD에 적용했을 때의 실제 에러
